"""
Django settings for raspy_glade_42384 project.
...
ROOT_URLCONF = 'raspy_glade_42384.urls'
...
WSGI_APPLICATION = 'raspy_glade_42384.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "raspy_glade_42384 API",
    "DESCRIPTION": "API documentation for raspy_glade_42384 App",
    "VERSION": "v1",
}
